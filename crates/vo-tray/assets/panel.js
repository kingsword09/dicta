    ...
    if (window.__voNativeGlass && shell) shell.classList.add('native-glass');
    ...
    const sendProviderSwitch = (provider) => {
      ...
      renderProviders(window.__voState || { providers: [] });
    ...
    window.__voUpdate = (state) => {
      window.__voState = state;
    ...
    window.__voUpdate(__VO_INITIAL_STATE__);
